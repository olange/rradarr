...
et explorer leur hiérarchie.
  ...
  $ rdoc -m README -t "Extraction des metadonnees d'un examen DICOM" .
  $ google-chrome doc/index.html &

== Exécuter les tests

Pour s'assurer que le code est fonctionnel. Les spécifications
permettent quant à elles de lire les exigences auxquelles répondent
les classes et de trouver des fragments de code pour invoquer celles-ci.
...
Décompresser au préalable, dans le sous-dossier <tt>test/valid-dicom/</tt>,
l'archive <tt>valid-dicom.tar.bz2</tt> qui s'y trouve.

== Mise en place de l'environnement

=== Créer un environnement RVM

Si vous utilisez RVM[beginrescueend.com/rvm/best-practices/] (Ruby enVironment
